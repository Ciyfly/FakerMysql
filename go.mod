...
require (
	github.com/Ciyfly/FakerVitess v0.0.2
...
replace github.com/dolthub/vitess => github.com/Ciyfly/FakerVitess v0.0.2

replace github.com/youtube/vitess => github.com/Ciyfly/FakerVitess v0.0.2
